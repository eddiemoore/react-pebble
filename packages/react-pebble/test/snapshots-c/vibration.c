...
static void window_load(Window *window) {
  ...
  text_layer_set_text(tl_0, "Vibration");
  layer_add_child(root, text_layer_get_layer(tl_0));

  s_tl0 = text_layer_create(GRect(0, 60, 144, 50));
  ...
  TextLayer *tl_1 = text_layer_create(GRect(0, 120, 144, 50));
  ...
  text_layer_set_text(tl_1, "UP = short pulse");
  ...
  text_layer_set_text(tl_2, "DOWN = long pulse");
  ...
  text_layer_set_text(tl_3, "SELECT = double pulse");
