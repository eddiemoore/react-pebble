...
// Source: examples/path.tsx rendered in Node mock mode.
//
...
class AppBehavior extends Behavior {
  ...
  onButton(e) {
    ...
    if (name === "up") { this.s0 += 15; this.refresh(); }
    if (name === "down") { this.s0 += 360; this.refresh(); }
...
const WatchApp = Application.template(() => ({
  ...
  contents: [
      new Container(null, { left: 0, right: 0, top: 0, bottom: 0, contents: [
        ...
        new Label(null, { top: 4, left: 4, width: 192, style: st0, string: "Path / Polygon" }),
        new RoundRect(null, { left: 97, top: 97, width: 6, height: 6, radius: 3, skin: sk1 }),
        new Content(null, { left: 95, width: 10, top: 50, height: 50, skin: sk2 }),
        new Content(null, { left: 10, width: 60, top: 160, height: 40, skin: sk3 }),
        new Content(null, { left: 140, width: 40, top: 170, height: 30, skin: sk4 }),
        new Label(null, { top: 205, left: 0, width: 200, style: st1, horizontal: "center", name: "sl1", string: "0° — UP/DOWN to rotate" })
      ] })
  ],
}));
