...
// Source: examples/vibration.tsx rendered in Node mock mode.
//
...
class AppBehavior extends Behavior {
  ...
  onButton(e) {
    ...
    if (name === "up") { this.s0 = "short"; this.refresh(); }
    if (name === "down") { this.s0 = "long"; this.refresh(); }
    if (name === "select") { this.s0 = "double"; this.refresh(); }
  }
  refresh() {
...
const WatchApp = Application.template(() => ({
  ...
  contents: [
      new Container(null, { left: 0, right: 0, top: 0, bottom: 0, contents: [
        ...
        new Label(null, { top: 6, left: 4, width: 192, style: st0, string: "Vibration" }),
        new Label(null, { top: 60, left: 0, width: 200, style: st1, horizontal: "center", name: "sl1", string: "Last: none" }),
        new Label(null, { top: 120, left: 0, width: 200, style: st2, horizontal: "center", string: "UP = short pulse" }),
        new Label(null, { top: 140, left: 0, width: 200, style: st2, horizontal: "center", string: "DOWN = long pulse" }),
        new Label(null, { top: 160, left: 0, width: 200, style: st2, horizontal: "center", string: "SELECT = double pulse" })
      ] })
  ],
}));
